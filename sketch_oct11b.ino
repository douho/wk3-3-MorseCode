...
void Dot () {digitalWrite(LedPin,HIGH); delay (shortLightTime); digitalWrite(LedPin,LOW); delay (codeSpaceTime);}
void Dash () {digitalWrite(LedPin,HIGH); delay (longLightTime); digitalWrite(LedPin,LOW);  delay (codeSpaceTime);}
